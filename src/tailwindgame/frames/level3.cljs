     ...
     [:div
      ...
      [:div
       ...
       [:div.relative.h-full.w-full.bg-slate-950.rounded-md.border.border-indigo-700.p-7
        [:img.absolute.top-7.right-7.h-20.w-20
         {:src "images/earth.png"}]
        
        [:img.absolute.top-7.left-7.h-20.w-20
         {:src "images/earth.png"}]
        ...
        [:div.flex.flex-1.w-full.h-full.p-4
         ...
         ;; if the class are empty or nil set justify-center as class, otherwise the @class.
         {:class 
          (if 
            (empty? (str @class)) 
            "justify-center" 
